Install Flask and APScheduler by using `sudo apt install python3-pip`, then `sudo pip3 install flask`, `sudo pip3 install numpy` and `sudo pip3 install apscheduler`
